...
function addDataToHTML() {
    ...
    // List of tea product IDs you want to display
    let teaProductIds = [4, 5, 7];

    // Filter products based on the specified IDs
    let teaProducts = products.filter(product => teaProductIds.includes(product.id));
...
// Call the function to display tea products
